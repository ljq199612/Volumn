...
<div class = 'data-section default-folding'>
<h2 class = 'section-title'>himawaripy(地球卫星桌面)</h2>
<div class = 'folding-area'>
...
**问: docker 里面的mysql 如何导出数据**

**答:**  
```bash 
# docker mysql8 实验时报错，需加上 --column-statistics=0 
mysqldump --column-statistics=0  -h 127.0.0.1 -u root -p mydb > /var/log/mysql/mydb.sql
# 明密方式
mysqldump --column-statistics=0  -h 127.0.0.1 -u root -p123456 mydb > /var/log/mysql/mydb.sql
```
...
# 指定版本
npm install docsify-cli@4.3.0 -g
